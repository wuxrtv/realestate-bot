...
async def lifespan(app: FastAPI):
    ...
    scheduler.add_job(whatsapp_bot.send_smart_random_offer,   "cron", hour=13, minute=30, id="wa_offer_1330",        coalesce=True, max_instances=1)
    scheduler.add_job(whatsapp_bot.send_smart_random_offer,   "cron", hour=17, minute=0,  id="wa_offer_1700",        coalesce=True, max_instances=1)
